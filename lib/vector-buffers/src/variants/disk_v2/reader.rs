    ...
    T: Bufferable,
{
    ...
    fn consumed_record_bytes(&self) -> Option<u64> {
        match self {
    ...
    FS::File: Unpin,
{
    ...
    /// `unread_buffer_size` must be the checkpoint-window size computed immediately before this
    /// call, after any writer realignment performed during startup.
    ///
    /// # Errors
    ///
